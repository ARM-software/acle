...
* Publication of the specifications in open source format. No functional changes intended.
...
The special symbol acts as an entry function attribute in the relocatable file.
Tools that operate on relocatable files can use this symbol to detect the need
to generate a secure gateway veneer ([7.4.3](#secure-gateway-veneers)) and a
symbol in the import library ([7.4.2](#executable-ﬁles)).
...
code into separate executable files as described in [7.4.2](#executable-ﬁles).
