...
`__ARM_FEATURE_B16B16` is defined to `1` if there is hardware support
for the non-widening SVE2.1 BF16 (FEAT_B16B16) instructions and if their
associated SVE intrinsics are available.

`__ARM_FEATURE_SME_B16B16` is defined to `1` if there is hardware support
for the SME2.1 FEAT_B16B16 instructions and if their associated SME
...
| [`__ARM_FEATURE_SME_B16B16`](#non-widening-brain-16-bit-floating-point-support)                                                                         | Non-widening brain 16-bit floating-point SME intrinsics (FEAT_B16B16)                              | 1           |
...
``` c
  ...
  //   _single_s8_x4
  //   _single_u8_x4,
  //   _single_bf16_x4 (only if __ARM_FEATURE_SME_B16B16)
  //   _single_s16_x4
  //   _single_u16_x4
  //   _single_s32_x4
  //   _single_u32_x4,
...
``` c
  ...
  //   _s8_x2
  //   _u8_x2
  //   _bf16_x2 (only if __ARM_FEATURE_SME_B16B16)
  //   _s16_x2
  //   _u16_x2,
  //   _s32_x2
  //   _u32_x2
  ...
  //   _s8_x4
  //   _u8_x4
  //   _bf16_x4 (only if __ARM_FEATURE_SME_B16B16)
  //   _s16_x4
  //   _u16_x4,
  //   _s32_x4
  //   _u32_x4
